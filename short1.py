...
def shortread1 (
    ...
    try:
        ...
        print(f"\n\nTotal time to execute Query 1: {total_time}\n\n")
...
def main():
    ...
    parser.add_argument("--output_path", default="LDBC_SF1/sr_output/sr1_output.csv", help="Path for the final output CSV file.")
