...
def obliviator_operator2 (
    ...
    Args:
        ...
        operator2_variant (str): Specifies which Operator 2 implementation to use.
                                "default" for ~/operator_2/
                                "opaque_shared_memory" for ~/opaque_shared_memory/operator_2/
    """
    ...
    obliv_op2_output_path = temp_dir / "obliv_op2_output.txt" # Intermediate copy for consistency
    ...
    print("Reverse-relabeled Operator 2 output written to " + str(ultimate_final_output_path) + ".\n\n")

    print(f"✅ Output of Obliviator Operator 2 written to: {ultimate_final_output_path}\n\n")
    return
...
def main():
    ...
    try:
        obliviator_operator2(
            ...
            args.operator2_variant # Pass operator2_variant last
        )
    except Exception as e:
