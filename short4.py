...
def main():
    ...
    parser.add_argument("--LDBC_dir_path", default="LDBC", help="Path to LDBC database.")
    parser.add_argument("--output_path", default="LDBC/sr4_output.csv", help="Path for the final output CSV file.")
